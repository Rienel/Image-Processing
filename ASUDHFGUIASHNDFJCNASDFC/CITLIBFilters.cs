...
namespace ImageProcess2
{
	...
	public class BitmapFilter
	{
        ...
        private int subtractionThreshold = 50;



        //PWEDE RBA NI BUTNGAN DRI SIR?
        public static bool Sepiaa(Bitmap b)
        {
            ...
            unsafe
            {
                ...
                for (int y = 0; y < b.Height; ++y)
                {
                    for (int x = 0; x < b.Width; ++x)
                    {
                        ...
                        p[2] = (byte)(tr > 255 ? 255 : tr);
                        p[1] = (byte)(tg > 255 ? 255 : tg);
                        p[0] = (byte)(tb > 255 ? 255 : tb);
        ...
        private Bitmap SubtractBackground(Bitmap imageA, Bitmap imageB)
        {
            ...
            for (int x = 0; x < imageA.Width; x++)
            {
                for (int y = 0; y < imageA.Height; y++)
                {
                    ...
                    // Check for dominant green pixels or apply the subtraction logic
                    if (pixel.G > pixel.R + subtractionThreshold && pixel.G > pixel.B + subtractionThreshold)
                    {
                        // Use the background pixel if the condition is satisfied
